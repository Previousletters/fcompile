...
def get_act_data(name, func, x_min, x_max, hfile_path='approx_pwlf_act.h'):
    ...
    with open(os.path.join(save_path, f'approx_pwlf_{name}.py'),'a') as file0:
        print(f"# activation: {func.__name__}, x_min: {x_min}, x_max: {x_max}", file=file0)
        print(f'{name}_wt = ', slopes.tolist(), file=file0)
        print(f'{name}_bias = ', b.tolist(), file=file0)
        print(f'{name}_x_region = ', bp_fp16.tolist()[1:], file=file0)
...
if __name__ == "__main__":
    ...
    save_path = "saved"
    func_args = [
#       [   str_act_name,   activation,     x_min,  x_max, hfile_path='approx_pwlf_act.h']
#        [          "exp",       np.exp,        -4,      4],
#        [         "gelu",         gelu,        -4,      4],
#        [         "tanh",      np.tanh,        -4,      4],
#        [      "sigmoid",      sigmoid,        -4,      4],
