...
struct MVM_Cfg Get_MVM_Cfg(int Hin, int Win, int CHin, int CHout, int in_feature_dw, int wt_dw, int wt_scale_dw)
{
    ...
    printf("total_bytes_if_reuse_wt=%0d,total_bytes_if_reuse_dat=%0d\n",total_bytes_if_reuse_wt,total_bytes_if_reuse_dat);
...
#ifdef Run_on_FPGA
void FPGA_MVM(struct MVM_Cfg mvm_cfg, int relu_en, struct Mapped_Feature* feature_in, struct Mapped_Weight* wt, struct Mapped_Feature* feature_out, int Out_to_BRAM, int In_from_BRAM, int out_base_addr, int in_base_addr)
{
        ...
        for (int n = 0; n < mvm_cfg.CHout_Split_Times; n = n + 1)
            for (int k = 0; k < mvm_cfg.Hout_Split_Times; k = k + 1)
            {
                ...
                FPGA_MVM_single_time(CH_in_single,in_height_single,mvm_cfg.Win,CH_out_single,mvm_cfg.Wout,Hout_single,
                        ...
                        ((uint64_t)wt->payload) + mvm_cfg.wt_size_in_bytes / mvm_cfg.CHout_Padding_with_Tout * mvm_cfg.out_ch_slice * n, 
                        ...
                        mvm_cfg.best_single_dat_banks,0,dma_wt_reuse_single);
            }
    }
        ...
        for (int k = 0; k < mvm_cfg.Hout_Split_Times; k = k + 1)
            for (int n = 0; n < mvm_cfg.CHout_Split_Times; n = n + 1)
            {
                ...
                FPGA_MVM_single_time(CH_in_single,in_height_single,mvm_cfg.Win,CH_out_single,mvm_cfg.Wout,Hout_single,
                        ...
                        mvm_cfg.best_single_dat_banks,dma_dat_reuse_single,0);
            }
    }
}
...
(
    ...
    int single_dat_buf_num, int dma_dat_reuse, int dma_wt_reuse)
{
