...
void FPGA_Run_LN(struct Mapped_Feature* feature_in, struct Mapped_Feature* wt_and_bias, struct Mapped_Feature* feature_out, int Height, int RMS_Norm, int LN_Out_and_In_Mode, HANDLE device=0);
...
void FPGA_Run_Feature2Weight(struct Mapped_Feature* feature_in, struct Mapped_Weight* weight_out, int Height, int Out_and_In_Mode, HANDLE device=0, int log2_WT_base_addr_Bank_Step=6, int Left_WT_Base_Addr=0);
...
void FPGA_Run_PosEmb(struct Mapped_Feature* feature_in, struct Mapped_Feature* pos_in, struct Mapped_Feature* feature_out, int Pos_Num, HANDLE device=0);
