...
#include "interface/ShapeInterface.cpp.inc"
...
///
struct InferShapePass
    : public mlir::PassWrapper<InferShapePass, OperationPass<func::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(InferShapePass)
  StringRef getArgument() const final { return "infershape"; }
  void runOnOperation() override {
    ...
    std::cout << "opWorklist: " << opWorklist.size() << std::endl;
...
std::unique_ptr<mlir::Pass> tdliron::createInferShapePass() {
